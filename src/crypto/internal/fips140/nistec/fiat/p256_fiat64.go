...
// p256SquareArm64Style squares a field element following ARM64 assembly algorithm
// This is a reference implementation for debugging purposes
func p256SquareArm64Style(out1 *p256MontgomeryDomainFieldElement, arg1 *p256MontgomeryDomainFieldElement) {
	x0 := arg1[0]
	x1 := arg1[1]
	x2 := arg1[2]
	x3 := arg1[3]
