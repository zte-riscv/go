...
func GoSyntax(inst Inst, pc uint64, symname func(uint64) (string, uint64), text io.ReaderAt) string {
	...
	case AMOADD_D, AMOADD_D_AQ, AMOADD_D_RL, AMOADD_D_AQRL, AMOADD_W, AMOADD_W_AQ,
		...
		AMOAND_H_RL, AMOCAS_B, AMOCAS_B_AQ, AMOCAS_B_AQRL, AMOCAS_B_RL, AMOCAS_D, AMOCAS_D_AQ,
		AMOCAS_D_AQRL, AMOCAS_D_RL, AMOCAS_H, AMOCAS_H_AQ, AMOCAS_H_AQRL, AMOCAS_H_RL, AMOCAS_Q,
		AMOCAS_Q_AQ, AMOCAS_Q_AQRL, AMOCAS_Q_RL, AMOCAS_W, AMOCAS_W_AQ, AMOCAS_W_AQRL, AMOCAS_W_RL,
		AMOMAXU_B, AMOMAXU_B_AQ, AMOMAXU_B_AQRL, AMOMAXU_B_RL, AMOMAXU_H, AMOMAXU_H_AQ, AMOMAXU_H_AQRL,
		AMOMAXU_H_RL, AMOMAX_B, AMOMAX_B_AQ, AMOMAX_B_AQRL, AMOMAX_B_RL, AMOMAX_H, AMOMAX_H_AQ,
		AMOMAX_H_AQRL, AMOMAX_H_RL, AMOMINU_B, AMOMINU_B_AQ, AMOMINU_B_AQRL, AMOMINU_B_RL, AMOMINU_H,
